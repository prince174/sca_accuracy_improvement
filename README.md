...
В ней разделены текущее поведение (SBOM формируется правилами, LLM объясняет) и
предложение с моделью в основном потоке. Второй режим не реализован в сервисе.
